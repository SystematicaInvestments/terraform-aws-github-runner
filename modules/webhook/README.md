...
| <a name="input_restricted_github"></a> [restricted\_github](#input\_restricted\_github) | When true, webhook Lambdas skip VPC placement. | `bool` | `true` | no |
...
| <a name="input_webhook_allowed_source_cidrs"></a> [webhook\_allowed\_source\_cidrs](#input\_webhook\_allowed\_source\_cidrs) | List of source CIDR ranges allowed to call the webhook. Leave empty to disable source IP filtering. | `list(string)` | `[]` | no |
