...
| <a name="input_restricted_github"></a> [restricted\_github](#input\_restricted\_github) | When true, the runner-binaries-syncer Lambda skips VPC placement. | `bool` | `true` | no |
