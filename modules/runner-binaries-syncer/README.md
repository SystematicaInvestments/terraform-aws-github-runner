...
| <a name="input_restricted_github"></a> [restricted\_github](#input\_restricted\_github) | When true, runner-binaries-syncer lambda skips VPC placement. | `bool` | `true` | no |
