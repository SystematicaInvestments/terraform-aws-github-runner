...
| <a name="input_http_proxy"></a> [http\_proxy](#input\_http\_proxy) | HTTP proxy URL for Lambda functions. | `string` | `null` | no |
...
| <a name="input_no_proxy"></a> [no\_proxy](#input\_no\_proxy) | Comma-separated list of hosts/domains to exclude from proxy. | `string` | `null` | no |
...
| <a name="input_restricted_github"></a> [restricted\_github](#input\_restricted\_github) | When true, ssm-housekeeper lambda skips VPC placement. | `bool` | `true` | no |
